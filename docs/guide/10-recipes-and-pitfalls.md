...
![She tastes a finished dish while robots cook from a recipe box, with pinned cards representing investigation, tests, and repeat-until-done work above the counter.](./images/recipes.jpg)
...
- **A vague finish condition.** "Make it better" gives a scheduler or durable goal nothing to check. Give a command or artifact that can pass or fail.
