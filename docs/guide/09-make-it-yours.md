...
You do not describe your style, because [`automate-me`](../../skills/automate-me/SKILL.md) reads it from your host's workspace-scoped history. It mines repeated preferences in replies, delegation, verification, code, prose, and process, then asks which patterns are really you. It drafts `<your-name>-mode/SKILL.md` in the host's project skill root through its installed skill-authoring workflow, runs the draft through [`unslop`](../../skills/unslop/SKILL.md), and opens a PR from a worktree so you review it like any other change.
