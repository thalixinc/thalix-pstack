...
Use at least two architect-capable runners from the host's available role catalog. Inherit the parent model unless the host confirms a useful alternative is available.
