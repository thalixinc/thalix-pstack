...
3. Plan the fix from the trace. If it crosses a function boundary, `architect` first. Delegate implementation to a host-native implementation agent and inherit the parent model by default. Review the diff. Capture a post-fix trace.
